...
export default function HowItWorksPage() {
 ...
 <h1 className=" text-4xl md:text-5xl lg:text-[64px] leading-tight text-[#182235]">
 How It Works
 </h1>
 ...
 <h3 className="mt-6 text-[32px] leading-tight text-[#182235]">
 {step.title}
 </h3>
 ...
 <h3 className="mt-5 text-2xl leading-tight text-[#182235]">
 {step.title}
 </h3>
 ...
 <h3 className="mt-4 text-xl sm:text-2xl leading-tight text-[#182235]">
 {step.title}
 </h3>
