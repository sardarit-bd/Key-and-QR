...
export const SIDEBAR_CONFIG = {
      ...
      children: [
        {
          ...
          title: "Submit",
          href: "/dashboard/user/submit-quote",
          visibility: MENU_VISIBILITY.ALL,
        },
        {
          id: "submission-history",
          title: "Submission History",
          href: "/dashboard/user/submit-quote/history",
          visibility: MENU_VISIBILITY.ALL,
        },
      ],
    },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          title: "Active Users",
          href: "/dashboard/admin/users/active",
          visibility: MENU_VISIBILITY.ADMIN,
        },
        {
        ...
        },
        {
          ...
          title: "Moderators",
          href: "/dashboard/admin/users/moderators",
          visibility: MENU_VISIBILITY.ADMIN,
        },
      ],
    },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: "/dashboard/admin/orders/pending-qr",
          visibility: MENU_VISIBILITY.ADMIN,
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: "/dashboard/admin/tags/assigned",
          visibility: MENU_VISIBILITY.ADMIN,
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: "/dashboard/admin/quotes/approved",
          visibility: MENU_VISIBILITY.ADMIN,
        },
        {
          id: "admin-quotes-rejected",
          title: "Rejected Quotes",
          href: "/dashboard/admin/quotes/rejected",
          visibility: MENU_VISIBILITY.ADMIN,
        },
      ],
    },
      ...
      children: [
        {
          ...
          title: "Homepage Hero",
          href: "/dashboard/admin/content/homepage-hero",
          visibility: MENU_VISIBILITY.ADMIN,
        },
        {
          id: "admin-content-shop-hero",
          title: "Shop Hero",
          href: "/dashboard/admin/content/shop-hero",
          visibility: MENU_VISIBILITY.ADMIN,
        },
        {
          ...
          icon: Megaphone,
          href: "/dashboard/admin/content/announcement",
          visibility: MENU_VISIBILITY.ADMIN,
        },
      ],
    },
  ...
  upgradeCard: {
    free: {
      ...
      ctaText: "Upgrade Now",
      ctaHref: "/dashboard/user/premium",
      show: true,
    },
    trial: {
