...
export default function Footer() {
 ...
 <div className="space-y-1 text-[16px] text-neutral-700 ">
 ...
 <p className=" mb-6 text-[17px] text-neutral-700 leading-relaxed">
 ...
 className=" flex-1 px-2 md:px-2 xl:px-1 lg:px-4 py-3 text-sm outline-none placeholder-neutral-400 font-medium"
 required
 />
