...
export default function PremiumQuoteDisplay({
 ...
 <div className="h-6 w-24 bg-muted rounded-lg mx-auto mb-6" />
 <div className="space-y-4 text-center">
 <div className="h-8 w-3/4 bg-muted rounded-lg mx-auto" />
 <div className="h-8 w-1/2 bg-muted rounded-lg mx-auto" />
 <div className="h-8 w-2/3 bg-muted rounded-lg mx-auto" />
 </div>
 <div className="mt-6 h-5 w-32 bg-muted rounded-lg mx-auto" />
 </div>
 );
 }
 ...
 <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-500/90 text-accent-foreground text-xs font-semibold rounded-full shadow-lg">
 ...
 animate={{ opacity: 1, y: 0 }}
 className="mt-6 text-2xl sm:text-3xl text-foreground font-light leading-relaxed max-w-2xl"
 >
 "{quote.text}"
 </motion.h1>
 ...
 initial={{ opacity: 0 }}
 animate={{ opacity: 1 }}
 className="mt-4 text-sm sm:text-base text-amber-300/60 "
 >
 — {quote.author} —
 </motion.p>
 )}
