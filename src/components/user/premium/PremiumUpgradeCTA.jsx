...
export default function PremiumUpgradeCTA() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-card to-card border border-border p-8"
    >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <Link href="/new-dashboard/user/premium">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-accent text-accent-foreground font-semibold rounded-full shadow-lg hover:brightness-90 transition flex items-center gap-2"
            >
              Upgrade Now
