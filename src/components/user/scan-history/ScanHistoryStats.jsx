...
const STAT_THEMES = {
  ...
  amber: {
    ...
    wash: 'bg-gradient-to-br from-amber-500/[0.06] via-transparent to-transparent',
 ...
 * Uses the Overview StatCard DNA: Card wrapper + themed icon tile.
 */
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="relative overflow-hidden rounded-2xl border border-white/6 bg-card p-5 animate-pulse light:border-[#E8DFCE]/80"
          >
