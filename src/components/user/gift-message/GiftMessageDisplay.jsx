...
export default function GiftMessageDisplay({
 ...
 <h2 id="gift-message-title" className="text-2xl text-white">
 ...
 <div className="absolute top-2 left-3 text-4xl text-amber-500/20 ">“</div>
 <div className="absolute bottom-2 right-3 text-4xl text-amber-500/20 ">”</div>
 </div>
 ...
 From Tag: <span className=" text-gray-400">{tagCode}</span>
 </p>
 </div>
 )}
