  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] xl:max-w-[1440px] xl:px-13 2xl:px-23">
        <div className="py-4">
          <div className="grid gap-6 lg:grid-cols-[350px_1fr] xl:grid-cols-[450px_1fr] items-center">
            {/* Left Content */}
            <motion.div
            ...
            >
              ...
              <h2 className=" text-[36px] md:text-[42px] leading-[1.1] text-black">
                Timeless charms
                <br />
                Made to inspire.
              </h2>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-5 bg-white">
                        <h3 className=" text-[18px] text-black group-hover:text-[#666] transition-colors duration-300">
                          {product.name}
                        </h3>
