import { Heart, Sparkles, Star, Flame, Smile, Copy, Check } from "lucide-react";
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full overflow-hidden">
                ...
                <div className="p-8">
                    <div className="relative mb-6">
                        ...
                        <p className="text-xl md:text-2xl text-gray-800 italic leading-relaxed px-4 py-2 text-center">
                            {message}
                        </p>
