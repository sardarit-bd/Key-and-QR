...
const CATEGORY_META = {
  faith: { bg: "bg-[#f5efe6]", accent: "text-[#c8a45d]", text: "Preparing today’s verse..." },
  love: { bg: "bg-[#f8eef0]", accent: "text-[#d79aa5]", text: "Opening your message..." },
  hope: { bg: "bg-[#eef2ee]", accent: "text-[#9fb1a5]", text: "Preparing a gentle message..." },
  success: { bg: "bg-[#f4eee7]", accent: "text-[#b79a72]", text: "Your message is ready..." },
  motivation: { bg: "bg-[#edf3f6]", accent: "text-[#8faebb]", text: "Finding your next step..." },
  personal: { bg: "bg-[#f7f1eb]", accent: "text-[#c5a07b]", text: "Preparing your message..." },
};
