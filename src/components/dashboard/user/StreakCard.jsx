...
export default function StreakCard() {
 ...
 <h2 className="text-lg tracking-wide w-full text-center mb-8 relative z-10 text-foreground">
 Inspiration Streak
 </h2>
 ...
 <span className=" text-[88px] leading-none text-accent">
 {streakDays}
 </span>
 <span className="mt-2 text-[22px] text-accent">
 Days
 </span>
 </div>
 </div>
