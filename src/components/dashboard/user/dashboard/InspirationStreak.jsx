...
/**
 * Count-up hook — eases the streak number up once on mount.
...
export default function InspirationStreak({ streak }) {
  ...
  <motion.div
    className="absolute h-[170px] w-[170px] rounded-full bg-accent/20 blur-[20px]"
  ...
  <h1 className=" text-[88px] leading-none text-accent drop-shadow-[0_0_12px_rgba(255,180,93,0.3)] tabular-nums">
  {animatedCurrent}
  </h1>
