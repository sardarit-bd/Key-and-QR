  ...
  return (
    <Card className="relative overflow-hidden rounded-[26px] border border-accent/20 p-5 sm:p-6 h-full">
      <div className="relative z-10 flex h-full flex-col items-center justify-center">
        <h2 className="text-[28px] sm:text-[34px] font-serif text-foreground text-center">
          Inspiration Streak
        </h2>
        ...
        <div className="relative mt-6 sm:mt-8 flex h-[220px] w-[220px] items-center justify-center scale-[0.85] sm:scale-100">
          ...
          <div className="relative z-20 text-center">
            <h1 className="font-serif text-[88px] leading-none text-accent drop-shadow-[0_0_12px_rgba(255,180,93,0.3)]">
              {current || 0}
            </h1>
            <p className="mt-2 font-serif text-[20px] text-accent drop-shadow-[0_0_8px_rgba(255,180,93,0.3)]">
              Days
            </p>
          </div>
        </div>

        <p className="mt-4 sm:mt-6 font-serif text-[18px] sm:text-[20px] text-foreground-secondary text-center">
