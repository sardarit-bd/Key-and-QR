      ...
      {cards.map((card, index) => {
        ...
        return (
          <motion.button
            ...
            className="group flex items-center justify-between p-3 sm:p-4 md:p-5 rounded-2xl bg-white/75 dark:bg-neutral-900/70 backdrop-blur-md dark:backdrop-blur-xl border border-white/80 dark:border-white/[0.08] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_4px_20px_-4px_rgba(0,0,0,0.05)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_8px_30px_rgba(0,0,0,0.35)] cursor-pointer transition-all duration-200 hover:bg-white/90 dark:hover:bg-neutral-800/80 hover:border-accent/40 dark:hover:border-white/20 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.8),0_8px_28px_-6px_rgba(0,0,0,0.08)] dark:hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1),0_12px_36px_rgba(0,0,0,0.4)]"
          >
