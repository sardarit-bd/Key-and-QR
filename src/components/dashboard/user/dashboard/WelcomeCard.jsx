    ...
    <section className="relative h-full min-h-[220px] sm:min-h-[240px] lg:min-h-[280px] w-full overflow-hidden rounded-[26px] border border-white/10 bg-card shadow-[0_20px_50px_-16px_rgb(0_0_0/0.55)]">
      ...
      <div className="relative z-10 flex h-full flex-col justify-center px-6 sm:px-8 md:px-10 py-6 sm:py-8">
        <div className="max-w-[400px]">
          ...
          <h2 className="text-[22px] sm:text-[26px] md:text-[30px] lg:text-[34px] leading-[1.2] tracking-tight text-foreground">
            Welcome{userName && userName !== 'there' ? `, ${userName}` : ''} ✨
          </h2>

          <p className="mt-3 text-[13px] sm:text-[14px] md:text-[15px] leading-6 text-foreground-secondary max-w-[340px]">
