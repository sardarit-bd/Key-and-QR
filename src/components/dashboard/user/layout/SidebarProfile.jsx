...
export default function SidebarProfile({ profile, isCollapsed }) {
 ...
 <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-primary via-primary/80 to-primary/60 flex items-center justify-center text-primary-foreground text-[32px] ring-[1px] ring-accent/40 shadow-[0_0_20px_rgba(227,186,133,0.15)] overflow-hidden">
 {hasAvatar ? (
 <img
 src={hasAvatar}
 alt={profile.name || 'User'}
 ...
 <h3 className="text-[17px] text-foreground tracking-wide mb-1">
 {profile.name}
 </h3>
