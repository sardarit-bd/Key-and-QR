/**
 * Icon utilities — maps icon names to SVG strings for Fabric.js rendering.
 *
 * Each SVG uses a 24x24 viewBox with stroke="currentColor" so the color
 * can be controlled via the icon's color property at render time.
 */

// Icon path definitions (matching lucide-react v1.x paths)
const ICON_DEFS = {
  sparkles:
  ...
  square:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"></rect></svg>',
  triangle:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"></path></svg>',
  crown:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H5.81a1 1 0 0 1-.957-.734L2.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z"></path><path d="M5 21h14"></path></svg>',
  gift:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 7v14"></path><path d="M20 11v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8"></path><path d="M7.5 7a1 1 0 0 1 0-5 4.8 8 0 0 1 4.5 4.5 4.8 8 0 0 1 4.5-4.5 1 1 0 0 1 0 10"></path><rect x="3" y="7" width="18" height="4" rx="1"></rect></svg>',
  bell:
  ...
  pause:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="14" y="3" width="5" height="18" rx="1"></rect><rect x="5" y="3" width="5" height="18" rx="1"></rect></svg>',
  bookmark:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z"></path></svg>',
  share2:
...
const ICON_LABELS = {
  ...
  minus: 'Minus', arrowup: 'Arrow Up', arrowdown: 'Arrow Down', arrowleft: 'Arrow Left',
  arrowright: 'Arrow Right', circle: 'Circle', square: 'Square', triangle: 'Triangle',
  crown: 'Crown', gift: 'Gift', bell: 'Bell', user: 'User', home: 'Home',
  calendar: 'Calendar', clock: 'Clock', camera: 'Camera', image: 'Image',
  music: 'Music', play: 'Play', pause: 'Pause', bookmark: 'Bookmark',
  share2: 'Share', settings: 'Settings', search: 'Search', quote: 'Quote',
  sun: 'Sun', moon: 'Moon',
};

export const ICON_LIST = Object.keys(ICON_DEFS).map((name) => ({
  name,
...
export function getIconSvg(iconName) {
  return ICON_DEFS[iconName] || ICON_DEFS.sparkles;
}

/**
 * Build an SVG string with a specific color and size.
 * Replaces "currentColor" in the path with the actual color.
 */
export function getIconSvgColored(iconName, color, size = 48) {
  const base = getIconSvg(iconName);
  const viewBoxSize = 24; // all icons use 24x24 viewBox
...
/**
 * Default icon configuration — freshly created for each new icon element.
 * Returns a new object every call to guarantee zero shared references.
 */
export function createDefaultIconConfig(iconName = 'sparkles') {
  return {
    iconName: iconName,
    size: 48,
    color: '#1a1a1a',
