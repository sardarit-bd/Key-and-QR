...
import { ShoppingBag, User, MapPin, CreditCard, Package, Clock } from 'lucide-react';
...
function Section({ title, children }) {
  return (
    <div className="border-b border-border/50 pb-3 mb-3 last:border-0 last:mb-0 last:pb-0">
      <h3 className="text-[11px] text-foreground-tertiary font-medium uppercase tracking-wider mb-2">{title}</h3>
      {children}
    </div>
  );
}
