 ...
 */}
 ...
 className=" text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[28px] text-black leading-[1.2] tracking-[-0.01em]"
 >
 MyInspiration is
 <br />
 always with you.
 ...
 <motion.p 
 variants={textVariants}
 className=" mt-4 text-sm sm:text-base md:text-lg text-gray-800 font-medium tracking-wide"
 >
